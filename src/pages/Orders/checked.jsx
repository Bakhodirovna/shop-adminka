...
const Checked = () => {
    ...
    <div className='container'>
        ...
        <div className="order">
            ...
            <NavLink className='order__rout__link ' to='/noCheck'>Tekshirilmaganlar</NavLink>
                <NavLink className='order__rout__link check__link' to='/checked' >Tekshirilganlar</NavLink>
            </div>
            <div className='order__box'>
                ...
                <div className="order__infos">
                    ...
                    <div className='order__infos__bottom' >
                        ...
                        <button className='order__infos__btn'>Tekshirildi</button>                    
                    </div>
                </div>
            </div>
        </div>
